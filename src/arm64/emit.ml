...
and g' oc = function (* 各命令のアセンブリ生成 (caml2html: emit_gprime) *)
  ...
  | _, CallDir(Id.L "min_caml_mul", ys, zs) -> g'_args oc [] ys zs; Printf.fprintf oc "\tb min_caml_mul\n"
  | _, CallDir(Id.L "min_caml_div", ys, zs) -> g'_args oc [] ys zs; Printf.fprintf oc "\tb min_caml_div\n"
  | _, CallDir(Id.L "min_caml_rem", ys, zs) -> g'_args oc [] ys zs; Printf.fprintf oc "\tb min_caml_rem\n"
