...
По-перше, у випадку визначення функції, let rec f x1 ... xn = e in ..., ми
...
У випадку загального виклику функції x y1 ... yn, Closure.g перевіряє,
...
Збереження необхідно не тільки при розливі резистерів, але і при
